# Runbook: SNMP overload

## Purpose

This runbook describes a repeatable NOC investigation for SNMP overload. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
