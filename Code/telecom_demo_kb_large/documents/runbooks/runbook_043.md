# Runbook: ISIS adjacency flap

## Purpose

This runbook describes a repeatable NOC investigation for ISIS adjacency flap. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
