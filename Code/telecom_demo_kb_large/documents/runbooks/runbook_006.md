...
This runbook describes a repeatable NOC investigation for high memory. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
