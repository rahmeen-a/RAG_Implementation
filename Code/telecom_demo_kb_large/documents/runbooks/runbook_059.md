# Runbook: QoS congestion

## Purpose

This runbook describes a repeatable NOC investigation for QoS congestion. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
