...
This runbook describes a repeatable NOC investigation for configuration rollback. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
