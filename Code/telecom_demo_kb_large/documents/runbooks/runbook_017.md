...
This runbook describes a repeatable NOC investigation for service degradation. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
