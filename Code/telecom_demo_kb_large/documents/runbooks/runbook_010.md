# Runbook: optical RX degradation

## Purpose

This runbook describes a repeatable NOC investigation for optical RX degradation. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
