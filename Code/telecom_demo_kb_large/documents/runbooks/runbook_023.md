# Runbook: software upgrade failure

## Purpose

This runbook describes a repeatable NOC investigation for software upgrade failure. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
