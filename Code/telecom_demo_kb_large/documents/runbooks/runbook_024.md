# Runbook: hardware replacement verification

## Purpose

This runbook describes a repeatable NOC investigation for hardware replacement verification. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
