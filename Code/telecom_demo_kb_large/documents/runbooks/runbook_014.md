# Runbook: route count anomaly

## Purpose

This runbook describes a repeatable NOC investigation for route count anomaly. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
