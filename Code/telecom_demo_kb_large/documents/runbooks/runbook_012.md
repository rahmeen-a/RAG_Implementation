# Runbook: latency increase

## Purpose

This runbook describes a repeatable NOC investigation for latency increase. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
