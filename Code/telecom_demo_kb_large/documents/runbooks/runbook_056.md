# Runbook: MPLS LDP issue

## Purpose

This runbook describes a repeatable NOC investigation for MPLS LDP issue. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
