# Runbook: interface link flapping

## Purpose

This runbook describes a repeatable NOC investigation for interface link flapping. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
