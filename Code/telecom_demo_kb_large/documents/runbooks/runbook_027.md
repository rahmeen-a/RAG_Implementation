# Runbook: VRF route leak

## Purpose

This runbook describes a repeatable NOC investigation for VRF route leak. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
