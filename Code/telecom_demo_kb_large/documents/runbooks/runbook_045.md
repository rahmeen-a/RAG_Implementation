...
This runbook describes a repeatable NOC investigation for route churn. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
