# Runbook: BGP neighbor flapping

## Purpose

This runbook describes a repeatable NOC investigation for BGP neighbor flapping. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
