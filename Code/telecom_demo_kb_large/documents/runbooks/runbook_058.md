# Runbook: ACL-related outage

## Purpose

This runbook describes a repeatable NOC investigation for ACL-related outage. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
