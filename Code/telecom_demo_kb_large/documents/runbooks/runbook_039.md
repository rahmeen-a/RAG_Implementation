# Runbook: CRC/input errors

## Purpose

This runbook describes a repeatable NOC investigation for CRC/input errors. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
