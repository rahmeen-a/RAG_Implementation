# Runbook: planned maintenance correlation

## Purpose

This runbook describes a repeatable NOC investigation for planned maintenance correlation. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
