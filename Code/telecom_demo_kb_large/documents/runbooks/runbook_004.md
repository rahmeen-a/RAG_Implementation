# Runbook: high CPU on PE router

## Purpose

This runbook describes a repeatable NOC investigation for high CPU on PE router. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
