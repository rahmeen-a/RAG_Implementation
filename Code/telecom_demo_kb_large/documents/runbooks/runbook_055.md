# Runbook: redundant path validation

## Purpose

This runbook describes a repeatable NOC investigation for redundant path validation. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
