# Runbook: high CPU on P router

## Purpose

This runbook describes a repeatable NOC investigation for high CPU on P router. It is designed to separate the observed alarm from the underlying fault and to preserve evidence.
