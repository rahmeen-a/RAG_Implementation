...
The synthetic baseline for bgp_prefix_count on PE-ISL-015 is based on a rolling operational window. Typical central behavior is around 400000, while the upper normal range approaches 950000. Investigation should begin around 1100000, with context from the current workload.
