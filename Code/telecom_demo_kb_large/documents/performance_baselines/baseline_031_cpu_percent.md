...
The synthetic baseline for cpu_percent on P-MUL-013 is based on a rolling operational window. Typical central behavior is around 28, while the upper normal range approaches 55. Investigation should begin around 75, with context from the current workload.
