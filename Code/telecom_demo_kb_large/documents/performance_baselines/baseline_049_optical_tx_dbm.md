...
The synthetic baseline for optical_tx_dbm on P-MUL-008 is based on a rolling operational window. Typical central behavior is around -1.0, while the upper normal range approaches 2.0. Investigation should begin around -3.0, with context from the current workload.
