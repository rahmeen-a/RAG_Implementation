...
The synthetic baseline for output_discards_per_5min on P-LAH-080 is based on a rolling operational window. Typical central behavior is around 0, while the upper normal range approaches 2. Investigation should begin around 10, with context from the current workload.
