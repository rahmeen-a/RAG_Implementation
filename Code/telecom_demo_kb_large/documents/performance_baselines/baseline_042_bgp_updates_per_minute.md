...
The synthetic baseline for bgp_updates_per_minute on BNG-RAW-044 is based on a rolling operational window. Typical central behavior is around 80, while the upper normal range approaches 500. Investigation should begin around 1500, with context from the current workload.
