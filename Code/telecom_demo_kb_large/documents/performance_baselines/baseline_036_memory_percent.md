...
The synthetic baseline for memory_percent on PE-RAW-006 is based on a rolling operational window. Typical central behavior is around 34, while the upper normal range approaches 62. Investigation should begin around 78, with context from the current workload.
