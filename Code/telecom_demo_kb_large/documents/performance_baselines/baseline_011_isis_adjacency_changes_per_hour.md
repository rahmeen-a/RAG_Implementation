...
The synthetic baseline for isis_adjacency_changes_per_hour on PE-LAH-026 is based on a rolling operational window. Typical central behavior is around 0, while the upper normal range approaches 2. Investigation should begin around 6, with context from the current workload.
