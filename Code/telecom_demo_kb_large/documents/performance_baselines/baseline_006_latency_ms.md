...
The synthetic baseline for latency_ms on PE-ISL-018 is based on a rolling operational window. Typical central behavior is around 5, while the upper normal range approaches 35. Investigation should begin around 80, with context from the current workload.
