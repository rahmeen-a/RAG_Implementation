...
The synthetic baseline for interface_utilization_percent on PE-RAW-006 is based on a rolling operational window. Typical central behavior is around 25, while the upper normal range approaches 70. Investigation should begin around 85, with context from the current workload.
