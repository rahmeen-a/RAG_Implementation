# Alarm Guide: POWER-INPUT-FAIL

## Alarm meaning

POWER-INPUT-FAIL is a synthetic critical alarm associated with site/device. The alarm should be interpreted as an observation, not an automatic root-cause classification.

## What commonly correlates

Related alarms may include OPTICAL-TX-LOW, HIGH-CPU, BGP-NEIGHBOR-FLAP. Correlation across time and topology can reveal whether the alarm is primary or downstream.
