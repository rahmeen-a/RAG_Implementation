# Alarm Guide: BGP-ROUTE-THRESHOLD

## Alarm meaning

BGP-ROUTE-THRESHOLD is a synthetic major alarm associated with BGP process. The alarm should be interpreted as an observation, not an automatic root-cause classification.

## What commonly correlates

Related alarms may include OPTICAL-TX-LOW, POWER-INPUT-FAIL, MEMORY-LEAK-SUSPECTED. Correlation across time and topology can reveal whether the alarm is primary or downstream.
