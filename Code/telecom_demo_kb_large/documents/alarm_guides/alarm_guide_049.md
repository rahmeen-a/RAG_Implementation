...
Related alarms may include HIGH-CPU, POWER-INPUT-FAIL, BGP-HOLD-TIMER-EXPIRED. Correlation across time and topology can reveal whether the alarm is primary or downstream.
