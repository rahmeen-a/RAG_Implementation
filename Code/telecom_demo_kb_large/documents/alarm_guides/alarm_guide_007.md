# Alarm Guide: LINK-FLAP

## Alarm meaning

LINK-FLAP is a synthetic major alarm associated with interface. The alarm should be interpreted as an observation, not an automatic root-cause classification.

## What commonly correlates

Related alarms may include ISIS-ADJ-DOWN, HIGH-MEMORY, BGP-ROUTE-THRESHOLD. Correlation across time and topology can reveal whether the alarm is primary or downstream.
