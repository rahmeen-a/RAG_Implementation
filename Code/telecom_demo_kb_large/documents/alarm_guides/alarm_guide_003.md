...
Related alarms may include BGP-ROUTE-THRESHOLD, ISIS-ADJ-DOWN, CRC-ERRORS. Correlation across time and topology can reveal whether the alarm is primary or downstream.
