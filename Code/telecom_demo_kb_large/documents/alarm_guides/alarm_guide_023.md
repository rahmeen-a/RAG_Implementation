...
Related alarms may include BGP-ROUTE-THRESHOLD, HIGH-CPU, LINK-DOWN. Correlation across time and topology can reveal whether the alarm is primary or downstream.
