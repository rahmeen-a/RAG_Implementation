...
Related alarms may include HIGH-CPU, BGP-HOLD-TIMER-EXPIRED, PACKET-LOSS. Correlation across time and topology can reveal whether the alarm is primary or downstream.
