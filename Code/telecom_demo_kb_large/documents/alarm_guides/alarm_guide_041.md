# Alarm Guide: PACKET-LOSS

## Alarm meaning

PACKET-LOSS is a synthetic major alarm associated with path. The alarm should be interpreted as an observation, not an automatic root-cause classification.

## What commonly correlates

Related alarms may include ISIS-ADJ-DOWN, MEMORY-LEAK-SUSPECTED, BGP-ROUTE-THRESHOLD. Correlation across time and topology can reveal whether the alarm is primary or downstream.
