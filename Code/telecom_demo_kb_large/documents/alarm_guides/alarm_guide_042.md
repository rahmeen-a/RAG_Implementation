...
Related alarms may include BGP-NEIGHBOR-DOWN, CRC-ERRORS, HIGH-CPU. Correlation across time and topology can reveal whether the alarm is primary or downstream.
