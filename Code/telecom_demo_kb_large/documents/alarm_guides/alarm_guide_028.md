# Alarm Guide: OPTICAL-RX-LOW

## Alarm meaning

OPTICAL-RX-LOW is a synthetic major alarm associated with optic. The alarm should be interpreted as an observation, not an automatic root-cause classification.

## What commonly correlates

Related alarms may include BGP-ROUTE-THRESHOLD, BGP-HOLD-TIMER-EXPIRED, ISIS-ADJ-DOWN. Correlation across time and topology can reveal whether the alarm is primary or downstream.
