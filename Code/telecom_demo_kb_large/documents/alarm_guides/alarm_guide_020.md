# Alarm Guide: HIGH-CPU

## Alarm meaning

HIGH-CPU is a synthetic major alarm associated with device. The alarm should be interpreted as an observation, not an automatic root-cause classification.

## What commonly correlates

Related alarms may include LINK-DOWN, CRC-ERRORS, BGP-ROUTE-THRESHOLD. Correlation across time and topology can reveal whether the alarm is primary or downstream.
