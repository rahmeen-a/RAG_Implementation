...
Related alarms may include LATENCY-HIGH, OPTICAL-RX-LOW, ISIS-ADJ-DOWN. Correlation across time and topology can reveal whether the alarm is primary or downstream.
