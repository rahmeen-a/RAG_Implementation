...
Related alarms may include HIGH-CPU, OPTICAL-TX-LOW, BGP-NEIGHBOR-FLAP. Correlation across time and topology can reveal whether the alarm is primary or downstream.
