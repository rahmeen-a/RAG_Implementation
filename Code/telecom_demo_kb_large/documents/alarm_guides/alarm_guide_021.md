# Alarm Guide: HIGH-MEMORY

## Alarm meaning

HIGH-MEMORY is a synthetic major alarm associated with device. The alarm should be interpreted as an observation, not an automatic root-cause classification.

## What commonly correlates

Related alarms may include CRC-ERRORS, OPTICAL-TX-LOW, BGP-NEIGHBOR-FLAP. Correlation across time and topology can reveal whether the alarm is primary or downstream.
