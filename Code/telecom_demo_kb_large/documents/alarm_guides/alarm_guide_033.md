...
Related alarms may include POWER-INPUT-FAIL, HIGH-CPU, OPTICAL-RX-LOW. Correlation across time and topology can reveal whether the alarm is primary or downstream.
