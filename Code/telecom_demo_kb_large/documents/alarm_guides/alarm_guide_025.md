...
Related alarms may include OPTICAL-RX-LOW, LATENCY-HIGH, MEMORY-LEAK-SUSPECTED. Correlation across time and topology can reveal whether the alarm is primary or downstream.
