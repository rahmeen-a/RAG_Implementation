# Alarm Guide: ISIS-ADJ-DOWN

## Alarm meaning

ISIS-ADJ-DOWN is a synthetic major alarm associated with IGP adjacency. The alarm should be interpreted as an observation, not an automatic root-cause classification.

## What commonly correlates

Related alarms may include PACKET-LOSS, BGP-NEIGHBOR-DOWN, OPTICAL-RX-LOW. Correlation across time and topology can reveal whether the alarm is primary or downstream.
