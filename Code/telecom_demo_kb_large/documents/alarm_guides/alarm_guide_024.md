# Alarm Guide: CRC-ERRORS

## Alarm meaning

CRC-ERRORS is a synthetic major alarm associated with interface. The alarm should be interpreted as an observation, not an automatic root-cause classification.

## What commonly correlates

Related alarms may include OPTICAL-TX-LOW, MEMORY-LEAK-SUSPECTED, HIGH-CPU. Correlation across time and topology can reveal whether the alarm is primary or downstream.
