# Alarm Guide: LATENCY-HIGH

## Alarm meaning

LATENCY-HIGH is a synthetic major alarm associated with path. The alarm should be interpreted as an observation, not an automatic root-cause classification.

## What commonly correlates

Related alarms may include POWER-INPUT-FAIL, CRC-ERRORS, OPTICAL-RX-LOW. Correlation across time and topology can reveal whether the alarm is primary or downstream.
