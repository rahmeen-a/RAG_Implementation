# Alarm Guide: MEMORY-LEAK-SUSPECTED

## Alarm meaning

MEMORY-LEAK-SUSPECTED is a synthetic major alarm associated with process. The alarm should be interpreted as an observation, not an automatic root-cause classification.

## What commonly correlates

Related alarms may include BGP-HOLD-TIMER-EXPIRED, LINK-DOWN, OPTICAL-RX-LOW. Correlation across time and topology can reveal whether the alarm is primary or downstream.
