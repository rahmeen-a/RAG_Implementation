# Huawei NE8000-X8: interface error counters

## Scope

Synthetic vendor-style troubleshooting note for Huawei NE8000-X8, focused on interface error counters. Use this as background technical knowledge after current network evidence has been collected.
