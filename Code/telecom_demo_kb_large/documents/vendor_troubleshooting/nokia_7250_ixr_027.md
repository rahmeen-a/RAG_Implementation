# Nokia 7250 IXR: BGP policy troubleshooting

## Scope

Synthetic vendor-style troubleshooting note for Nokia 7250 IXR, focused on BGP policy troubleshooting. Use this as background technical knowledge after current network evidence has been collected.
...
For BGP policy troubleshooting, common interpretations include transient convergence, persistent physical impairment, configuration mistakes, resource contention, management-plane load, or software-specific behavior. The correct interpretation depends on correlated evidence.
