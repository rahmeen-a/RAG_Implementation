# Cisco NCS5508: MPLS label troubleshooting

## Scope

Synthetic vendor-style troubleshooting note for Cisco NCS5508, focused on MPLS label troubleshooting. Use this as background technical knowledge after current network evidence has been collected.
