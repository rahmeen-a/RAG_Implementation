# Juniper PTX10008: route table growth

## Scope

Synthetic vendor-style troubleshooting note for Juniper PTX10008, focused on route table growth. Use this as background technical knowledge after current network evidence has been collected.
...
For route table growth, common interpretations include transient convergence, persistent physical impairment, configuration mistakes, resource contention, management-plane load, or software-specific behavior. The correct interpretation depends on correlated evidence.
