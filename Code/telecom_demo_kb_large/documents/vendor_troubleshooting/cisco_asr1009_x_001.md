# Cisco ASR1009-X: BGP process troubleshooting

## Scope

Synthetic vendor-style troubleshooting note for Cisco ASR1009-X, focused on BGP process troubleshooting. Use this as background technical knowledge after current network evidence has been collected.
...
For BGP process troubleshooting, common interpretations include transient convergence, persistent physical impairment, configuration mistakes, resource contention, management-plane load, or software-specific behavior. The correct interpretation depends on correlated evidence.
