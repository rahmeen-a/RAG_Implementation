# Juniper MX960: SNMP polling load

## Scope

Synthetic vendor-style troubleshooting note for Juniper MX960, focused on SNMP polling load. Use this as background technical knowledge after current network evidence has been collected.
