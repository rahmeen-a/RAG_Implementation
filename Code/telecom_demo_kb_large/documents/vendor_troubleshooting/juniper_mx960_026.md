# Juniper MX960: route table growth

## Scope

Synthetic vendor-style troubleshooting note for Juniper MX960, focused on route table growth. Use this as background technical knowledge after current network evidence has been collected.
