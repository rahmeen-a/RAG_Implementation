# Topology Context: PE-LAH-077

## Device context

PE-LAH-077 is a PE device using Nokia 7750 SR-12 and SR OS 23.10. It is located at POP-LAH-02 in Lahore and is classified critical.

## Immediate neighborhood

Synthetic topology relationships place the device among peers such as PE-LAH-061, EDGE-PES-047, and P-FAI-058. The exact adjacency should be resolved from the structured topology store rather than inferred from this narrative.
