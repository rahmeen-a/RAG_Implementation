...
Synthetic topology relationships place the device among peers such as PE-FAI-078, PE-RAW-042, and RR-PES-065. The exact adjacency should be resolved from the structured topology store rather than inferred from this narrative.
