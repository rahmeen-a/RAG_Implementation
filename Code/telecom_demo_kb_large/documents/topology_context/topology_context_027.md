# Topology Context: P-LAH-080

## Device context

P-LAH-080 is a P device using Juniper MX960 and Junos 23.2R1. It is located at POP-LAH-03 in Lahore and is classified major.

## Immediate neighborhood

Synthetic topology relationships place the device among peers such as P-RAW-038, RR-LAH-045, and PE-MUL-017. The exact adjacency should be resolved from the structured topology store rather than inferred from this narrative.
