# Topology Context: PE-ISL-062

## Device context

PE-ISL-062 is a PE device using Juniper MX960 and Junos 23.2R1. It is located at POP-ISL-03 in Islamabad and is classified critical.

## Immediate neighborhood

Synthetic topology relationships place the device among peers such as BNG-RAW-066, RR-PES-023, and PE-MUL-075. The exact adjacency should be resolved from the structured topology store rather than inferred from this narrative.
