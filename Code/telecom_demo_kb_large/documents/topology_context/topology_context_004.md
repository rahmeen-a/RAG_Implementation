...
Synthetic topology relationships place the device among peers such as EDGE-KAR-072, P-ISL-027, and PE-KAR-059. The exact adjacency should be resolved from the structured topology store rather than inferred from this narrative.
