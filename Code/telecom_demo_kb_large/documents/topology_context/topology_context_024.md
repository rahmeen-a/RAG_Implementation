...
Synthetic topology relationships place the device among peers such as PE-ISL-018, P-PES-053, and PE-FAI-078. The exact adjacency should be resolved from the structured topology store rather than inferred from this narrative.
