...
Synthetic topology relationships place the device among peers such as RR-PES-065, BNG-LAH-070, and PE-RAW-042. The exact adjacency should be resolved from the structured topology store rather than inferred from this narrative.
