# Topology Context: PE-ISL-012

## Device context

PE-ISL-012 is a PE device using Nokia 7750 SR-12 and SR OS 23.10. It is located at POP-ISL-02 in Islamabad and is classified critical.

## Immediate neighborhood

Synthetic topology relationships place the device among peers such as PE-FAI-078, P-LAH-080, and BNG-PES-039. The exact adjacency should be resolved from the structured topology store rather than inferred from this narrative.
