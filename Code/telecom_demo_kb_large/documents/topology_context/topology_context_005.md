...
Synthetic topology relationships place the device among peers such as EDGE-PES-047, PE-LAH-007, and BNG-LAH-029. The exact adjacency should be resolved from the structured topology store rather than inferred from this narrative.
