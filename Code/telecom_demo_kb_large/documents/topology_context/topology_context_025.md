# Topology Context: BNG-RAW-066

## Device context

BNG-RAW-066 is a BNG device using Juniper PTX10008 and Junos 23.2R1. It is located at POP-RAW-03 in Rawalpindi and is classified major.

## Immediate neighborhood

Synthetic topology relationships place the device among peers such as BNG-PES-039, EDGE-PES-071, and RR-LAH-041. The exact adjacency should be resolved from the structured topology store rather than inferred from this narrative.
