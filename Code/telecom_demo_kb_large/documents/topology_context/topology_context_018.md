# Topology Context: PE-LAH-007

## Device context

PE-LAH-007 is a PE device using Nokia 7750 SR-12 and SR OS 23.10. It is located at POP-LAH-02 in Lahore and is classified critical.

## Immediate neighborhood

Synthetic topology relationships place the device among peers such as EDGE-PES-071, RR-KAR-056, and PE-MUL-075. The exact adjacency should be resolved from the structured topology store rather than inferred from this narrative.
