# Topology Context: RR-LAH-036

## Device context

RR-LAH-036 is a RR device using Juniper MX480 and Junos 23.2R1. It is located at POP-LAH-03 in Lahore and is classified critical.

## Immediate neighborhood

Synthetic topology relationships place the device among peers such as PE-ISL-051, BNG-RAW-044, and P-RAW-038. The exact adjacency should be resolved from the structured topology store rather than inferred from this narrative.
