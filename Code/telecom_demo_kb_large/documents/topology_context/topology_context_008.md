...
Synthetic topology relationships place the device among peers such as P-MUL-013, BNG-LAH-029, and PE-MUL-001. The exact adjacency should be resolved from the structured topology store rather than inferred from this narrative.
