...
Synthetic topology relationships place the device among peers such as PE-MUL-025, BNG-RAW-044, and EDGE-RAW-014. The exact adjacency should be resolved from the structured topology store rather than inferred from this narrative.
