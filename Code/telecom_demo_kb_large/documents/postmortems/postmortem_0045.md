# Postmortem INC-2026-0165

## Executive summary

INC-2026-0165 occurred on P-RAW-038 in POP-RAW-01. The incident presented as High memory. Service impact was assessed using the service dependency map, not only the alarm severity.
