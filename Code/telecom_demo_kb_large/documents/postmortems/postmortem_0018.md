# Postmortem INC-2026-0138

## Executive summary

INC-2026-0138 occurred on EDGE-PES-047 in POP-PES-02. The incident presented as Route count anomaly. Service impact was assessed using the service dependency map, not only the alarm severity.
