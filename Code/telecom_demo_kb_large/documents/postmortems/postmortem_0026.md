# Postmortem INC-2026-0146

## Executive summary

INC-2026-0146 occurred on EDGE-RAW-030 in POP-RAW-01. The incident presented as BGP neighbor down. Service impact was assessed using the service dependency map, not only the alarm severity.
