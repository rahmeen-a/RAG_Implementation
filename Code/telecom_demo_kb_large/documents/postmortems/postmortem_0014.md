# Postmortem INC-2026-0134

## Executive summary

INC-2026-0134 occurred on EDGE-KAR-072 in POP-KAR-03. The incident presented as High memory. Service impact was assessed using the service dependency map, not only the alarm severity.
