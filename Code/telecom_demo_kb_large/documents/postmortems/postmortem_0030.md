# Postmortem INC-2026-0150

## Executive summary

INC-2026-0150 occurred on RR-KAR-056 in POP-KAR-03. The incident presented as High CPU. Service impact was assessed using the service dependency map, not only the alarm severity.
