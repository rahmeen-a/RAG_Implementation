# Postmortem INC-2026-0140

## Executive summary

INC-2026-0140 occurred on BNG-FAI-019 in POP-FAI-02. The incident presented as BGP flapping. Service impact was assessed using the service dependency map, not only the alarm severity.
