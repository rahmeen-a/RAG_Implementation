# Postmortem INC-2026-0173

## Executive summary

INC-2026-0173 occurred on BNG-FAI-019 in POP-FAI-02. The incident presented as BGP neighbor down. Service impact was assessed using the service dependency map, not only the alarm severity.
