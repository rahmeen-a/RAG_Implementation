# Postmortem INC-2026-0141

## Executive summary

INC-2026-0141 occurred on RR-FAI-054 in POP-FAI-01. The incident presented as Link down. Service impact was assessed using the service dependency map, not only the alarm severity.
