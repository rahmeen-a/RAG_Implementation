# Postmortem INC-2026-0159

## Executive summary

INC-2026-0159 occurred on PE-ISL-051 in POP-ISL-01. The incident presented as BGP neighbor down. Service impact was assessed using the service dependency map, not only the alarm severity.
